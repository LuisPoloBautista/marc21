...
Se realiza una única estructuración de la evidencia seleccionada. No hay segunda búsqueda ni solicitudes dirigidas. Los datos faltantes se revisan manualmente. Hasta 5 imágenes totales por solicitud, incluidas las páginas de PDF que requieren OCR; las imágenes adjuntas tienen prioridad. Las páginas PDF con texto no consumen este cupo.
