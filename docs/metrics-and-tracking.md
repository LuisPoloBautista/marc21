...
Los totales se conservan; el historial detallado retiene las últimas 100 solicitudes (el panel muestra 10). No se guardan imágenes, texto del documento ni claves API en este archivo. Las solicitudes abortadas por un cierre abrupto del proceso pueden no quedar contabilizadas; este panel no sustituye el reporte de facturación del proveedor.
